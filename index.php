...
<main>
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img src="https://fichasop.cf/assets/img/Mauro%20-%20up%20.png" width="150" height="150"
            ...
            <div class="col-lg-4">
                <img src="https://fichasop.cf/assets/img/Man.png" width="150" height="150"
            ...
            <div class="col-lg-4">
                <img src="https://fichasop.cf/assets/img/foto.jpg" width="150" height="150"
                     class="bg-dark rounded-circle mx-3 border border-1 border-white">
                <h2>Melhorando</h2>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <img src="https://fichasop.cf/assets/img/atributo.png" width="500" height="500"
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
                <img src="https://fichasop.cf/assets/img/saude.png" width="500" height="500"
                     class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto">
            </div>
        </div>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <img src="https://fichasop.cf/assets/img/rolar.gif" width="500" height="500"
                     class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto">
