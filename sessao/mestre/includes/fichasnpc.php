                    ...
                    while ($r = mysqli_fetch_array($fichanpcs)){
                        ...
                        <div class="col-xxl-6 card-body border-0 text-center" id="npc<?=$r["id"]?>">
                            <div class="card bg-black border-light">
                                <div class="clearfix">
                                    <button class="btn btn-sm float-end text-danger" onclick="deletnpc(<?=$r["id"]?>);"><i class="fa-regular fa-trash"></i></button>
                                </div>
                                <div class="card-header border-0">
                                    ...
                                    <div id="saude">
                                        <div class="mt-4">
                                            ...
                                            <div class="clearfix" style="height: 40px;" id="pv">
                                                <div class="fs-4" style="text-align: center; height: 0px;" id="pvpva"><?=$r["pva"]?>/<?=$r["pv"]?></div>
                                                <div class="float-start" style="height: 0px;">
                                                    <button class="btn btn-sm text-white" onclick="updtvida(-5,<?=$r["id"]?>);" style="height: 40px;">
                                                        <i class="fa-solid fa-chevrons-left"></i> -5
                                                    </button>
                                                    <button class="btn btn-sm text-white" onclick="updtvida(-1,<?=$r["id"]?>);" style="height: 40px;">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar bg-danger progress-bar-striped progress-bar-animated" style="width: <?=($r["pva"]/$r["pv"])*100;?>%;" role="progressbar" aria-valuenow="<?=$r["pva"]?>" aria-valuemin="0" aria-valuemax="<?=$r["pva"]?>"></div>
                                            </div>
                                        </div>
                                        <?php
                                        if ($r["san"]>0){
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <div class="clearfix" style="height: 40px;" id="san">
                                                    <div class="fs-4" style="text-align: center; height: 0px;" id="sansana"><?=$r["sana"]?>/<?=$r["san"]?></div>
                                                    <div class="float-start" style="height: 0px;">
                                                        <button class="btn btn-sm text-white" onclick="updtsan(-5,<?=$r["id"]?>);" style="height: 40px;"><i class="fa-solid fa-chevrons-left"></i> -5</button>
                                                        <button class="btn btn-sm text-white" onclick="updtsan(-1,<?=$r["id"]?>);" style="height: 40px;"><i class="fa-solid fa-chevron-left"></i> -1</button>
                                                    </div>
                                                    <div class="float-end" style="height: 0px;">
                                                        <button class="btn btn-sm text-white" onclick="updtsan(1,<?=$r["id"]?>);" style="height: 40px;">+1 <i class="fa-solid fa-chevron-right"></i></button>
                                                        <button class="btn btn-sm text-white" onclick="updtsan(5,<?=$r["id"]?>);" style="height: 40px;">+5 <i class="fa-solid fa-chevrons-right"></i></button>
                                                    </div>
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" style="width: <?=($r["sana"]/$r["san"])*100;?>%;" role="progressbar" aria-valuenow="<?=$r["sana"]?>" aria-valuemin="0" aria-valuemax="<?=$r["san"]?>"></div>
                                                </div>
                                            </div>
                                            <?php
                                        }
        ...
        <form class="modal-content bg-black border-light" id="formaddnpc" method="post" autocomplete="off">
            <div class="card-header">
                <ul class="nav nav-pills mb-3 row justify-content-center" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item col-auto" role="presentation">
                        <button class="nav-link" id="pills-out-tab" data-bs-toggle="pill" data-bs-target="#pills-out" type="button" role="tab" aria-controls="pills-out" aria-selected="false">etc.</button>
                    </li>
                </ul>
            </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-dados" role="tabpanel" aria-labelledby="pills-dados-tab">
                        ...
                        <div class="m-2">
                            ...
                            <input id="pe" class="form-control bg-black text-light" name="pe" type="number" min="0" max="50" value="0"/>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-attr" role="tabpanel" aria-labelledby="pills-attr-tab">
                        <div class="containera text-white" id="atributos" title="Atributos, clique para editar">
                            <input required class="atributos for form-control rounded-circle bg-transparent text-white font4" type="number" min="-10" max="10" value='0' name="forca" aria-label="Força"/>
                            <input required class="atributos agi form-control rounded-circle bg-transparent text-white font4" type="number" min="-10" max="10" value='0' name="agilidade" aria-label="Agilidade"/>
                            <input required class="atributos int form-control rounded-circle bg-transparent text-white font4" type="number" min="-10" max="10" value='0' name="intelecto" aria-label="Intelecto"/>
                            <input required class="atributos pre form-control rounded-circle bg-transparent text-white font4" type="number" min="-10" max="10" value='0' name="presenca" aria-label="Presença"/>
                            <input required class="atributos vig form-control rounded-circle bg-transparent text-white font4" type="number" min="-10" max="10" value='0' name="vigor" aria-label="Vigor"/>
                        ...
                        <div class="row m-2">
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="atletismo" class="input-group-text bg-black text-light" name="atletismo" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="atualidades">Atualidades</label>
                                    <input id="atualidades" class="input-group-text bg-black text-light" name="atualidades" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="ciencia">Ciências</label>
                                    <input id="ciencia" class="input-group-text bg-black text-light" name="ciencia" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="diplomacia">Diplomacia</label>
                                    <input id="diplomacia" class="input-group-text bg-black text-light" name="diplomacia" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="enganacao" class="input-group-text bg-black text-light" name="enganacao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="fortitude">Fortitude</label>
                                    <input id="fortitude" class="input-group-text bg-black text-light" name="fortitude" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="furtividade" class="input-group-text bg-black text-light" name="furtividade" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="intimidacao">Intimidação</label>
                                    <input id="intimidacao" class="input-group-text bg-black text-light" name="intimidacao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="intuicao">Intuição</label>
                                    <input id="intuicao" class="input-group-text bg-black text-light" name="intuicao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="investigacao">Investigação</label>
                                    <input id="investigacao" class="input-group-text bg-black text-light" name="investigacao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="luta">Luta</label>
                                    <input id="luta" class="input-group-text bg-black text-light" name="luta" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="medicina" class="input-group-text bg-black text-light" name="medicina" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="ocultismo">Ocultismo</label>
                                    <input id="ocultismo" class="input-group-text bg-black text-light" name="ocultismo" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="percepcao" class="input-group-text bg-black text-light" name="percepcao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="pilotagem">Pilotagem</label>
                                    <input id="pilotagem" class="input-group-text bg-black text-light" name="pilotagem" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="pontaria" class="input-group-text bg-black text-light" name="pontaria" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="prestidigitacao">Prestidigitação</label>
                                    <input id="prestidigitacao" class="input-group-text bg-black text-light" name="prestidigitacao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="profissao" class="input-group-text bg-black text-light" name="profissao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="reflexos">Reflexos</label>
                                    <input id="reflexos" class="input-group-text bg-black text-light" name="reflexos" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="religiao" class="input-group-text bg-black text-light" name="religiao" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="tatica">Tática</label>
                                    <input id="tatica" class="input-group-text bg-black text-light" name="tatica" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    ...
                                    <input id="tecnologia" class="input-group-text bg-black text-light" name="tecnologia" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="input-group">
                                    <label class="input-group-text bg-black text-light" for="vontade">Vontade</label>
                                    <input id="vontade" class="input-group-text bg-black text-light" name="vontade" type="number" min="0" max="50" value="0"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-out" role="tabpanel" aria-labelledby="pills-out-tab">
                        <div>
                            ...
                            <div class="m-2">
                                ...
                                <input id="passiva" class="form-control bg-black text-light" name="passiva" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="bloqueio">Bloqueio</label>
                                <input id="bloqueio" class="form-control bg-black text-light" name="bloqueio" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="esquiva">Esquiva</label>
                                <input id="esquiva" class="form-control bg-black text-light" name="esquiva" type="number" min="0" max="50" value="0"/>
                            </div>
                            <h2 class="my-2">Resistências</h2>
                            <div class="m-2">
                                <label class="fs-4" for="morte">Morte</label>
                                <input id="morte" class="form-control bg-black text-light" name="morte" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="sangue">Sangue</label>
                                <input id="sangue" class="form-control bg-black text-light" name="sangue" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="energia">Energia</label>
                                <input id="energia" class="form-control bg-black text-light" name="energia" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="conhecimento">Conhecimento</label>
                                <input id="conhecimento" class="form-control bg-black text-light" name="conhecimento" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="fisica">Fisica</label>
                                <input id="fisica" class="form-control bg-black text-light" name="fisica" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="balistica">Balistica</label>
                                <input id="balistica" class="form-control bg-black text-light" name="balistica" type="number" min="0" max="50" value="0"/>
                            </div>
                            <div class="m-2">
                                <label class="fs-4" for="mental">Mental</label>
                                <input id="mental" class="form-control bg-black text-light" name="mental" type="number" min="0" max="50" value="0"/>
                            </div>
                        </div>
                    </div>
                </div>
