                    ...
                    <div class="col-lg p-1 mx-lg-1 my-1 card bg-black border-light">
                        <div class="card-body">
                            ...
                            <div class="pt-3" id="divfotourl" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <input id="fotourl" class="form-control bg-black text-light border-light" name="fotourl" type="url" required disabled/>
                            ...
                            <div class="pt-3">
                                ...
                                <input class="form-control bg-black text-light border-light" type="number" min="0" max="65" id="idade" name="idade"  required="required"/>
                                <div class="invalid-feedback">
                            ...
                            <div class="pt-3">
                                ...
                                <select class="form-select bg-black text-light border-light" id="origem" name="origem"  required="required">
                            ...
                            <div class="pt-3">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <select class="form-select bg-black text-light border-light" id="trilha" name="classe" disabled required>
                            ...
                            <div class="pt-3">
                                ...
                                <input class="form-control bg-black text-light border-light" id="nex" type="number" min="0" max="99" name="nex" required/>
                                <div class="invalid-feedback">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="container p-0">
                                ...
                                <div class="containera text-white" id="atributos" title="Atributos, clique para editar">
                                    <input required class="atributos for form-control rounded-circle bg-transparent text-white font4" type="number" min="-5" max="5" value=0 name="forca" aria-label="Força"/>
                                    <input required class="atributos agi form-control rounded-circle bg-transparent text-white font4" type="number" min="-5" max="5" value=0 name="agilidade" aria-label="Agilidade"/>
                                    <input required class="atributos int form-control rounded-circle bg-transparent text-white font4" type="number" min="-5" max="5" value=0 name="intelecto" aria-label="Intelecto"/>
                                    <input required class="atributos pre form-control rounded-circle bg-transparent text-white font4" type="number" min="-5" max="5" value=0 name="presenca" aria-label="Presença"/>
                                    <input required class="atributos vig form-control rounded-circle bg-transparent text-white font4" type="number" min="-5" max="5" value=0 name="vigor" aria-label="Vigor"/>
                                    <img src="../../../assets/img/Atributos.png" alt="Atributos">
                                </div>
                                <div class="p-2 m-1">
                                    <label for="pv" class="fs-4 fw-bold">Vida Maxima (PV)</label><span title="Depende do Arquétipo, olhe a wiki oficial">(Deixe 1 para calcular automaticamente)</span>
                                    ...
                                    <label for="pe" class="fs-4 fw-bold">Pontos de Esforço (PE)</label><span title="Depende do Arquétipo, olhe a wiki oficial">(Deixe 1 para calcular automaticamente)</span>
