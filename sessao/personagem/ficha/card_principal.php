...
<div class="col-md pb-2 px-1">
    <div class="card h-100 bg-black border-light" id="card_principal">
        <div class="card-body p-0">
            ...
            <div class="clearfix">
                <div class="float-end">
                    <button class="btn btn-sm text-warning" data-bs-toggle="modal" data-bs-target="#editprincipal" title="Editar">
            ...
            <div class="row m-0">
                ...
                <div class="col d-flex align-self-center flex-column">
                    <div class="m-2">
                        <input type="checkbox" class="btn-check" id="morrendo" <?php if($morrendo)echo"checked ";if (!$edit){echo"disabled";}?> autocomplete="off">
                        <label class="d-grid btn btn-outline-danger fw-bolder" for="morrendo">Morrendo</label>
                    </div>
                    <div class="m-2">
                        <input type="checkbox" class="btn-check" id="enlouquecendo" <?php if($enlouquecendo)echo"checked ";if (!$edit){echo"disabled";}?> autocomplete="off">
                        <label class="d-grid btn btn-outline-primary fw-bolder" for="enlouquecendo">Enlouquecendo</label>
                    </div>
                </div>
            </div>
            <div class="m-2">
                ...
                <div class="progress h-auto bg-dark fw-bolder" id="barrapv" style="height: 150%;zoom:200%;">
                    <div class="progress-bar bg-danger text-end" id="progresspv" role="progressbar" title="Vida" style="width:<?=$ppv;?>%;height: 10px" aria-valuenow="<?=$pva?>" aria-valuemin="0" aria-valuemax="<?=$pv?>"></div>
                </div>
                <label for="progresssan" class="font6 pt-4 fs-4 fw-bold">Sanidade</label>
                <div class="clearfix" style="height: 40px;" id="san">
                    <div class="fs-4" style="text-align: center; height: 0px;" id="sansana"><?=$sana;?>/<?=$san;?></div>
                    <?php if ($edit){?>
                        <div class="float-start" style="height: 0px;">
                ...
                <div class="progress h-auto bg-dark fw-bolder" id="barrasan" style="height: 100%;zoom:200%;">
                    <div class="progress-bar bg-primary text-end" id="progresssan" role="progressbar" title="Sanidade Mental" style="height: 10px;width: <?=$psan?>%" aria-valuenow="<?=$sana?>" aria-valuemin="0" aria-valuemax="<?=$san?>"></div>
                </div>
                </div>
                <?php
