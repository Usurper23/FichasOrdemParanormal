            ...
            <form class="modal-body" id="formeditpri">
                ...
                <div class="m-2">
                    ...
                    <div class="input-group input-group-sm m-1">
                        <label for="epvtotal" class="border-info input-group-text bg-black text-white border-end-0 ">Vida
                            total</label>
                        <input id="epvtotal" class="border-info form-control bg-black text-white border-start-0"
                               type="number" name="pv" value="<?php echo $pv; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="esantotal" class="input-group-text bg-black text-white border-end-0">Sanidade
                            total</label>
                        <input id="esantotal" class="form-control bg-black text-white border-start-0" type="number"
                               name="san" value="<?php echo $san; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="epetotal" class="border-info input-group-text bg-black text-white border-end-0">Esforço
                            total</label>
                        <input id="epetotal" class="border-info form-control bg-black text-white border-start-0"
                               type="number" name="pe" value="<?php echo $pe; ?>"/>
                    </div>
                </div>
                <div class="m-2">
                    ...
                    <div class="input-group input-group-sm m-1">
                        ...
                        <input id="epass" class="form-control bg-black text-white border-start-0" type="number"
                               name="passiva" value="<?php echo $passiva; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="ebloq" class="border-info input-group-text bg-black text-white border-end-0">Bloqueio</label>
                        <input id="ebloq" class="border-info form-control bg-black text-white border-start-0"
                               type="number" name="bloqueio" value="<?php echo $bloqueio; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="eesqui" class="border-info input-group-text bg-black text-white border-end-0">Esquiva</label>
                        <input id="eesqui" class="border-info form-control bg-black text-white border-start-0"
                               type="number" name="esquiva" value="<?php echo $esquiva; ?>"/>
                    </div>
                </div>
                <div class="m-2">
                    ...
                    <div class="input-group input-group-sm m-1">
                        ...
                        <input id="ebal" class="form-control bg-black text-white border-start-0" type="number"
                               name="balistica" value="<?php echo $balistica; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="efis" class="input-group-text bg-black text-white border-end-0">Física</label>
                        <input id="efis" class="form-control bg-black text-white border-start-0" type="number"
                               name="fisica" value="<?php echo $fisica; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="emor" class="input-group-text bg-black text-white border-end-0">Morte</label>
                        <input id="emor" class="form-control bg-black text-white border-start-0" type="number"
                               name="morte" value="<?php echo $morte; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="econ" class="input-group-text bg-black text-white border-end-0">Conhecimento</label>
                        <input id="econ" class="form-control bg-black text-white border-start-0" type="number"
                               name="conhecimento" value="<?php echo $conhecimento; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="esan" class="input-group-text bg-black text-white border-end-0">Sangue</label>
                        <input id="esan" class="form-control bg-black text-white border-start-0" type="number"
                               name="sangue" value="<?php echo $sangue; ?>"/>
                    </div>
                    <div class="input-group input-group-sm m-1">
                        <label for="eene" class="input-group-text bg-black text-white border-end-0">Energia</label>
                        <input id="eene" class="form-control bg-black text-white border-start-0" type="number"
                               name="energia" value="<?php echo $energia; ?>"/>
                    </div>
