            ...
            <form class="modal-body" id="formeditdet">
                ...
                <div class="">
                    ...
                    <div class="m-2" id="divfotourl">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <input id="fotourl" class="form-control bg-black text-light border-light" name="fotourl"
                                       type="url" value="<?= $urlphoto ?>" required/>
                    ...
                    <div class="m-2">
                        ...
                        <input id="enome" class="form-control bg-black text-light" name="nome" value="<?= $nome ?>"
                               required/>
                    ...
                    <div class="m-2">
                        ...
                        <input id="etrilha" class="form-control bg-black  text-light " readonly name="trilha"
                               value="<?= $trilha ?>"/>
                    </div>
                    ...
                    <div class="m-2">
                        ...
                        <input id="eidade" class="form-control bg-black  text-light " type="number" name="idade"
                               value="<?= $rqs["idade"] ?>"/>
                    </div>

                    <div class="m-2">
                        <label class="fs-4" for="elocal">Local de nascimento</label>
                        <input id="elocal" class="form-control bg-black  text-light " type="text" name="local"
                               value="<?= $local ?>"/>
                    </div>

                    <div class="m-2">
                        <label class="fs-4" for="ehistoria">Hístoria</label>
                        <textarea id="ehistoria" name="historia"
                                  class="form-control bg-black text-light "><?= $historia ?></textarea>
                    </div>
                </div>
