    ...
    <div class="card h-100 bg-black border-light">
        <div class="card-body p-0 font1">
            <div class="clearfix">
                <?php if ($edit) { ?>
                    <div class="float-end">
                        <button class="btn btn-sm text-warning" data-bs-toggle="modal" data-bs-target="#edithab"
                ...
                <div class="m-3 clearfix">
                    ...
                    if ($edit) {
                        ...
                        <button class="btn btn-sm fa fa-trash text-danger float-end"
                                title="Apagar Habilidade '<?= $r["nome"]; ?>'"
                                onclick="deletehab(<?= $r["id"]; ?>)"></button>
                    <?php }
                    ?>
                    <textarea id="h<?= $r["id"]; ?>" class="form-control bg-black text-light border-0 font7"
                              disabled><?= $r["descricao"]; ?></textarea>
                </div>
            <?php
            endforeach;
