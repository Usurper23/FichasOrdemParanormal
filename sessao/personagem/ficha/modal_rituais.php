                ...
                <div class="container-fluid my-2">
                    ...
                    <div class="col text-center">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="aralv">Alvo:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="aralv" name="alvo"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="aralc">Alcance:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="aralc" name="alcance"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="ardur">Duração:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="ardur" name="duracao"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="arres">Resistência:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="arres" name="resistencia"/>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="m-4">
                            ...
                            <div class="teedfa" id="aff<?=$r["id"]?>">
                                <div class="m-2">
                                    <label for="fotosimbolo<?=$r["id"]?>" class="fs-4 fw-bold ">Foto do ritual</label>
                                    <select class="form-select bg-black text-light border-light fotosimbolo" id="fotosimbolo<?=$r["id"]?>" name="foto[]">
                                        <option value="1" <?=intval($r["foto"])?"selected":""?>>Desconhecido</option>
                                        <option value="2" <?=intval($r["foto"])?"":"selected"?>>Customizada</option>
                                    </select>
                                </div>
                                <div class="m-2 divfotosimbolourl"  <?=intval($r["foto"])?"style='display: none;'":""?>>
                                    <label for="simbolourl<?=$r["id"]?>" class="fs-4 fw-bold">Link da imagem</label>
                                    <input id="simbolourl<?=$r["id"]?>" class="form-control bg-black text-light border-light simbolourl" name="simbolourl[<?=$r["id"]?>]" value="<?=$r["foto"]?>" type="url" required  <?=intval($r["foto"])?"disabled":""?>/>
                                    <div class="invalid-feedback">A Imagem precisa ser valida.</div>
                                </div>
                                <div class="col text-center">
                            ...
                            <div class="input-group m-1">
                                ...
                                <input required type="text" class="form-control bg-black text-white border-start-0" id="arname<?=$r["id"]?>" name="ritual[]" value="<?=$r["nome"]?>"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="arcir<?=$r["id"]?>">Circulo:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="arcir<?=$r["id"]?>" name="circulo[]" value="<?=$r["circulo"]?>"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="arele<?=$r["id"]?>">Elemento:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="arele<?=$r["id"]?>" name="elemento[]" value="<?=$r["elemento"]?>"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="arcon<?=$r["id"]?>">Conjuração:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="arcon<?=$r["id"]?>" name="conjuracao[]" value="<?=$r["conjuracao"]?>"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="aralv<?=$r["id"]?>">Alvo:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="aralv<?=$r["id"]?>" name="alvo[]" value="<?=$r["alvo"]?>"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="aralc<?=$r["id"]?>">Alcance:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="aralc<?=$r["id"]?>" name="alcance[]" value="<?=$r["alcance"]?>"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="ardur<?=$r["id"]?>">Duração:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="ardur<?=$r["id"]?>" name="duracao[]" value="<?=$r["duracao"]?>"/>
                            </div>
                            <div class="input-group m-1">
                                <label class="input-group-text input-group-sm bg-black text-white border-end-0" for="arres<?=$r["id"]?>">Resistência:</label>
                                <input type="text" class="form-control bg-black text-white border-start-0" id="arres<?=$r["id"]?>" name="resistencia[]" value="<?=$r["conjuracao"]?>"/>
                            </div>
                            <label class="fs-4" for="arefe<?=$r["id"]?>">Efeito:</label>
                            <textarea required id="arefe<?=$r["id"]?>" name="efeito[]" class="form-control form-control-sm bg-black text-white"><?=$r["nome"]?></textarea>
                        </div>
                    </div>
