...
-- Tempo de geração: 22/04/2022 às 00:45
...
CREATE TABLE `fichas_npc` (
  ...
  `pv` smallint(3) DEFAULT 1,
  `pva` smallint(3) DEFAULT 1,
...
CREATE TABLE `fichas_personagem` (
  ...
  `pv` smallint(3) DEFAULT NULL,
  `pva` smallint(3) DEFAULT NULL,
  `san` smallint(3) DEFAULT NULL,
  `sana` smallint(3) DEFAULT NULL,
  `pe` smallint(3) DEFAULT NULL,
  `pea` smallint(3) DEFAULT NULL,
...
CREATE TABLE `inventario` (
  ...
  `prestigio` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `rituais` (
  ...
  `resistencia` varchar(30) DEFAULT NULL,
